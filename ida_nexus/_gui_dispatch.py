...
def create_dispatcher() -> GuiDispatcher | None:
    import ida_auto
    import ida_kernwin

    # Unit-test and non-GUI IDAPython shims do not provide a Qt event loop or
    # IDA timer registration. Their execute_sync implementation remains the
    # appropriate dispatch seam.
    if not hasattr(ida_kernwin, "register_timer"):
        return None
